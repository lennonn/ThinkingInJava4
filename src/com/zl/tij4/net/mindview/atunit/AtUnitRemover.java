...
package com.zl.tij4.net.mindview.atunit;
...
import com.zl.tij4.net.mindview.util.BinaryFile;
import com.zl.tij4.net.mindview.util.ProcessFiles;
    ...
    try {
      ...
      for(CtMethod method : ctClass.getDeclaredMethods()) {
        ...
        for(Annotation ann : attr.getAnnotations()) {
          if(ann.getTypeName()
             .startsWith("com.zl.tij4.net.mindview.atunit")) {
